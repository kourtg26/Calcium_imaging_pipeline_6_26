...
def main(cfg):
    ...
    post_s=cfg["freezing_metrics"].get("post_s", cfg["freezing_metrics"].get("trace_window_post_s"))
    peak_s=cfg["freezing_metrics"]["peak_window_s"]
    if post_s is None:
        raise KeyError("freezing_metrics.post_s (or trace_window_post_s) is required.")
