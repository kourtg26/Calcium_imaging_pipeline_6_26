#!/usr/bin/env python3
"""Plot Ext2 EarlyOnly -> Ret LateOnly matched-cell AUC correlations split by sex."""
...
OUTDIR = ROOT / "matched_cell_crossed_session_analysis_2of3_3s" / "ext2_earlyonly_to_ret_lateonly_sex_correlation"
PAIR_FILE = (
    ROOT
...
def main() -> None:
    ...
    fig.suptitle("Ext2 EarlyOnly -> Ret LateOnly AUC Correlations by Sex", fontsize=13, y=0.995)
    fig.tight_layout()
    png_path = OUTDIR / "Ext2_EarlyOnly_to_Ret_LateOnly_AUC_correlations_bySex.png"
    fig.savefig(png_path, dpi=220, bbox_inches="tight")
    plt.close(fig)

    cell_csv = OUTDIR / "Ext2_EarlyOnly_to_Ret_LateOnly_pairs_bySex.csv"
    stats_csv = OUTDIR / "Ext2_EarlyOnly_to_Ret_LateOnly_correlation_stats_bySex.csv"
