#!/usr/bin/env python3
"""Plot Ext2 LateOnly -> Ret EarlyOnly matched-cell AUC correlations split by sex."""
...
OUTDIR = ROOT / "matched_cell_crossed_session_analysis_2of3_3s" / "ext2_lateonly_to_ret_earlyonly_sex_correlation"
PAIR_FILE = (
    ROOT
...
def main() -> None:
    ...
    sub["comparison"] = "Ext2 LateOnly -> Ret EarlyOnly"
    sub["source_session"] = "Ext2"
    sub["source_class"] = "LateOnly"
    ...
    fig.suptitle("Ext2 LateOnly -> Ret EarlyOnly AUC Correlations by Sex", fontsize=13, y=0.995)
    fig.tight_layout()
    png_path = OUTDIR / "Ext2_LateOnly_to_Ret_EarlyOnly_AUC_correlations_bySex.png"
    fig.savefig(png_path, dpi=220, bbox_inches="tight")
    plt.close(fig)

    cell_csv = OUTDIR / "Ext2_LateOnly_to_Ret_EarlyOnly_pairs_bySex.csv"
    stats_csv = OUTDIR / "Ext2_LateOnly_to_Ret_EarlyOnly_correlation_stats_bySex.csv"
